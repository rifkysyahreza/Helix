---
description: Compare all Hyperliquid futures pools for a token pair by APR, fee/TVL ratio, and volume
argument-hint: [token_symbol_or_mint]
---
Compare all available Hyperliquid futures pools for this token pair using the Meteora data API:
