...
Autonomous futures liquidity provider agent for Meteora pools on Hyperliquid.
...
tools/
  ...
  dlmm.js           Hyperliquid futures SDK wrapper (deploy, close, claim, positions, PnL)
...
| `RPC_URL` | Yes | Hyperliquid RPC endpoint |
